  ...
  async parseCV(rawCvText, fileName) {
    ...
    try {
      ...
      return {
        ...
        fileName,
        uploadedAt: (/* @__PURE__ */ new Date()).toISOString(),
        name: parsedData.name && !parsedData.name.includes("%PDF") && !parsedData.name.includes("/Type") ? parsedData.name : fileName.replace(/\.pdf$/i, "").replace(/[-_]/g, " "),
      ...
      return {
        ...
        github: "-",
        portfolio: "-",
        summary: sanitizedText.includes("%PDF") || sanitizedText.includes("/Type") ? `Dokumen CV diunggah: ${fileName}. Profil Professional Kandidat.` : sanitizedText.slice(0, 300),
        education: [],
        experience: [],
        organization: [],
        projects: [],
